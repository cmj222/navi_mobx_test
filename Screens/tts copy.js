...
export default class App extends Component {
  ...
  constructor(props) {
    super(props);
    // tts가 가지는 고유 이벤트...음성재생이나 종료 취소등의 이벤트를 캐치하게 해줌.
    ...
    // 플랫폼에 따라서 tts엔진기동에 시간걸림. 그전에 tts.speak하면 오류나니 기다리는 코드
    // 엔진기동하고 나면, initTts시행.
  ...
  renderVoiceItem = ({ item }) => {
    ...
    // 음성리스트의 아이템을 보이스로 받아서 시행.
    // 보이스의 언어를 기본언어로 설정하기를 시도한다.
    ...
    // 기본언어가 되든 안되든 해당 보이스를 기본보이스로 설정하고 스테이트에 반영한다.
